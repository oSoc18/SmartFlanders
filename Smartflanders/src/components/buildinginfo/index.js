...
export class BuildingInfo extends Component {
    render() {
        ...
        let url = 'https://www.openstreetmap.org/export/embed.html?bbox=latitude%2Clongitude%2Clatitude%2Clongitude&amp;layer=mapnik&amp;marker=longitude%2Clatitude'.replace(regexLat, lat).replace(regexLon, long)
        console.log(url)
        return (
